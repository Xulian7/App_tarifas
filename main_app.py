...
from image_editor import open_image_editor
...
def main():
    ...
    btn_OCR = tk.Button(frame_info, text="OCR", image=cargar_imagen("Ocr"), compound="left" , command=open_image_editor)
    btn_OCR.grid(row=1, column=0, padx=5, pady=5, sticky="ew")
